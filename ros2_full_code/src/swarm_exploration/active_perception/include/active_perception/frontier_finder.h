...
private:
  ...
  double ground_clearance_{0.2};  // Cells below this z are dropped during expansion.
  double viewpoint_z_pin_{0.0};   // Quadruped: force viewpoint z to this (0 disables).
