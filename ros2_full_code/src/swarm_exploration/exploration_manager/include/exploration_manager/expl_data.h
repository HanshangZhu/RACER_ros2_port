// ROS 2 port of exploration_manager/expl_data.h
// Wave 7: replaced ros::Time with rclcpp::Time.
...
struct FSMData {
  ...
  rclcpp::Time fsm_init_time_;
  rclcpp::Time last_check_frontier_time_;
...
struct ExplorationParam {
  ...
  std::string mtsp_dir_;  // resource dir of tsp solver
  double relax_time_;
  int init_plan_num_;
