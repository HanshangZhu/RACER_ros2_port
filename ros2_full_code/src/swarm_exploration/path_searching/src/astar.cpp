...
void Astar::setParam(const rclcpp::Node::SharedPtr& node) {
  resolution_ = declare_or_get<double>(node, "astar.resolution_astar", -1.0);
  time_resolution_ = declare_or_get<double>(node, "astar.time_resolution", -1.0);
  lambda_heu_ = declare_or_get<double>(node, "astar.lambda_heu", -1.0);
  margin_ = declare_or_get<double>(node, "astar.margin", -1.0);
  allocate_num_ = declare_or_get<int>(node, "astar.allocate_num", -1);
