...
private:
  ...
  MarkerPub traj_pub_;       // 0
  MarkerPub topo_pub_;       // 1
  MarkerPub predict_pub_;    // 2
  MarkerPub visib_pub_;      // 3, visibility constraints
  MarkerPub frontier_pub_;   // 4, frontier searching
  MarkerPub yaw_pub_;        // 5, yaw trajectory
  MarkerPub viewpoint_pub_;  // 6, viewpoint planning
  vector<MarkerPub> pubs_;   //
