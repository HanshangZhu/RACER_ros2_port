...
// ROS 2 port of Map3D. Sparse 3D occupancy grid expressed as per-cell vertical
// occupancy lists. Messages were migrated to the generated ROS 2 IDL
...
private:
  ...
  void CheckDecayMap() {
    ...
    auto clock = clock_ ? clock_ : std::make_shared<rclcpp::Clock>(RCL_ROS_TIME);
